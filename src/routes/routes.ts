...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IApiResponse_IUsers_": {
        "dataType": "refObject",
        "properties": {
            "status": {"dataType":"double","required":true},
            "token": {"dataType":"string"},
            "data": {"dataType":"union","subSchemas":[{"ref":"IUsers"},{"dataType":"enum","enums":[null]}],"required":true},
            "error": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},
        },
        "additionalProperties": false,
    },
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IApiResponse_IUsers-Array_": {
        "dataType": "refObject",
        "properties": {
            "status": {"dataType":"double","required":true},
            "token": {"dataType":"string"},
            "data": {"dataType":"union","subSchemas":[{"dataType":"array","array":{"dataType":"refObject","ref":"IUsers"}},{"dataType":"enum","enums":[null]}],"required":true},
            "error": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},
        },
        "additionalProperties": false,
    },
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/api/user/signup',
            ...
            const args = {
                    user: {"in":"body","name":"user","required":true,"ref":"Partial_IUsers_"},
            };
        ...
        app.post('/api/user/signin',
            ...
            const args = {
                    user: {"in":"body","name":"user","required":true,"ref":"ILogin"},
            };
        ...
        app.get('/api/user/users',
            ...
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.users)),

            function UserController_users(request: any, response: any, next: any) {
            const args = {
            };
